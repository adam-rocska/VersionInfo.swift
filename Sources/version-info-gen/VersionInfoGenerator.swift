...
struct VersionInfoGenerator: AsyncParsableCommand {
  ...
  mutating func run() async throws {
    ...
    let swiftCode = """
      ...
      // Represents a Git ref resolved at build time.
      // This tuple intentionally matches VersionInfo.Version.
      // Plugin-only consumers do not need to link VersionInfo,
      // while library consumers can pass refs to SemanticVersion.
